...
<div class="ppolicy-container">
    ...
    <p>
        {{
            __(
                "Your privacy is important to us. It is Cut.It's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://cutit.com, and other sites we own and operate."
            )
        }}
    </p>
    <p>
        {{
            __(
                "This policy is effective as of 23 December 2021 and was last updated on 23 December 2021."
            )
        }}
    </p>
    ...
    <h3>{{ __("Collection and Use of Information") }}</h3>
    <p>
        {{
            __(
    ...
    <ul>
        ...
        <li>{{ __("When you mention us on social media") }}</li>
    </ul>
    <p>
        {{
            __(
    ...
    <h3>{{ __("Security of Your Personal Information") }}</h3>
    <p>
        {{
            __(
    ...
    <h3>{{ __("How Long We Keep Your Personal Information") }}</h3>
    <p>
        {{
            __(
    ...
    <h2>{{ __("Disclosure of Personal Information to Third Parties") }}</h2>
    ...
    <ul>
        ...
        <li>
            {{ __("our existing or potential agents or business partners") }}
        </li>
        <li>
            {{
                __(
    ...
    <h2>{{ __("International Transfers of Personal Information") }}</h2>
    <p>
        {{
            __(
