...
<div class="ppolicy-container">
    ...
    <p>
        {{
            __(
                "Your privacy is important to us. It is Cut.It's policy to respect your privacy and comply with all applicable laws and regulations regarding any personal information we may collect about you, including on this site and other sites we own and operate."
            )
        }}
    </p>
    <p>
    ...
    <ul>
        <li>
            {{ __("the original link you want to shorten") }}
        </li>
        <li>
            {{ __("the shortened link") }}
        </li>
        <li>
            {{ __("the date the shortened link was first created") }}
        </li>
        <li>*{{ __('the date the link was "updated"') }}</li>
        <li>
            {{ __("the date the link was last used") }}
        </li>
    </ul>
    <p>
        {{
    ...
    <p>
        *{{
            __(
                'A link is "updated" when a user wants to shorten a link that already exists in our database, which resets the countdown to removing it from the database.'
            )
        }}
    </p>
